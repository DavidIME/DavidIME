...
class Calculadora(tk.Tk):
    ...
    def _creacion_componentes(self):
        ...
        entrada_frame.pack(side=tk.TOP) #se ppublicara en la parte superior
        ...
        #creamos otro frame para los botones inferiores
        botones_frame = tk.Frame(self, width=400, height=50, bg = 'grey')
        botones_frame.pack()

        #primer renglon de botones
        #boton de limpiar
        boton_limpiar = tk.Button(botones_frame, text='CLEAN', width='30',
                                  height=3, bd=0, bg='#eee',  cursor = 'hand2'
        ...
        boton_dividir = tk.Button(botones_frame, text = '/', width = 10, height=3, bd=0, bg='#eee', cursor='hand2',
                                  ...
                                  #con lambda se ejecutara la funcion hasta que sea presionado
    ...
    def _evento_evaluar(self):
        ...
        try:
            ...
            self.expresion = ''  # se tiene que inicializar con cadena vacia despues de cada operacion para que no se acumulen
